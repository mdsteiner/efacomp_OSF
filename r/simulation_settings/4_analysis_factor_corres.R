...
saveRDS(res_deviance, "output/simulation_settings/results_factor_corres_settings_450.RDS")
...
res_deviance <- do.call(rbind, results)
saveRDS(res_deviance, "output/simulation_settings/results_factor_corres_NE_settings_450.RDS")
