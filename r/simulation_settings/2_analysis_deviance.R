...
recovery <- recovery %>%
  select(case:g, comm_meth:error, -iter)
...
saveRDS(res_deviance, "output/simulation_settings/results_deviance_settings_180.RDS")
...
res_deviance <- do.call(rbind, results)
saveRDS(res_deviance, "output/simulation_settings/results_deviance_NE_settings_180.RDS")
