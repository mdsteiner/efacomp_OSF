...
recovery <- recovery %>%
  select(case:n_factors, heywood, comm_meth:error, -iter)
...
saveRDS(res_deviance, "output/simulation_settings/results_heywood_settings_180.RDS")
...
res_deviance <- do.call(rbind, results)
saveRDS(res_deviance, "output/simulation_settings/results_heywood_NE_settings_180.RDS")
